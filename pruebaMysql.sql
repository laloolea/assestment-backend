...
CREATE TABLE IF NOT EXISTS countries (id LONG AUTO_INCREMENT NOT NULL PRIMARY KEY, name VARCHAR (50),
       capital VARCHAR(50), population int, languageId int);

CREATE TABLE IF NOT EXISTS languages (id long AUTO_INCREMENT NOT NULL PRIMARY KEY, name VARCHAR (50));	
